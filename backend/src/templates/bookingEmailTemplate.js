...
<body>
  <div class="container">
    <div class="header">
      <img src="https://directevents.click/${isArabic ? 'directxmlAR.png' : 'directxml.png'}" alt="Direct Events logo" style="max-width: 150px; height: auto; margin-bottom: 15px;">
    ...
    <div class="footer">
      <p>&copy; 2026 Direct Events. ${isArabic ? 'جميع الحقوق محفوظة' : 'All Rights Reserved.'}</p>
      <p>Direct Events & Services - International Conferences & Exhibitions</p>
      <p style="margin-top: 10px; font-size: 10px; opacity: 0.7;">
        ${isArabic ? 'هذا إشعار تلقائي من نظام الحجز الخاص بموقع Direct Events.' : 'This is an automated notification from the Direct Events booking system.'}<br>
        DirectEvents Powered by <a href="https://dipencil.com/" style="color: inherit; text-decoration: underline;">diPencil Studio</a>
      </p>
    </div>
  </div>
</body>
