...
export default function Home() {
  ...
  const whyUsCards = (t("whyUs.cards") as unknown as any[]) || []
  ...
  const jsonLd = {
    ...
    "logo": "https://directevents.click/logo.png",
    "description": "شريككم الموثوق في تنظيم وحجز المؤتمرات والمعارض الدولية بكل احترافية.",
    "sameAs": [
      "https://twitter.com/directevents",
      "https://instagram.com/directevents"
    ]
  };
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden">
      ...
      <main className="flex-1">
        ...
        <section id="features" className="pt-32 md:pt-64 pb-32 relative overflow-hidden bg-slate-50/50">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center text-center mb-20">
              ...
              <h2 className={`text-3xl md:text-6xl ${isRtl ? 'font-bold' : 'font-extrabold'} tracking-tighter text-[#0f172a] mb-6 max-w-4xl leading-[1.1]`}>
                {isRtl ? (
                  <>حوّل فعاليتك القادمة إلى <span className="animate-text-mesh">مركز قوة</span> واستقطاب</>
                ) : (
                  <>Transform Your Next Event into a <span className="animate-text-mesh">Powerhouse</span></>
                )}
              </h2>
              <p className="text-lg text-slate-500 max-w-2xl mx-auto font-medium">
                {isRtl ? "كل ما تحتاجه لتنظيم وإدارة الفعاليات الكبرى في منصة واحدة متكاملة." : "Everything you need to organize and manage major events in one integrated platform."}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white/70 backdrop-blur-sm animate-mesh rounded-[2.5rem] p-6 md:p-10 border border-slate-200 shadow-md flex flex-col items-start text-start overflow-hidden relative group min-h-[400px]"
              >
                <h3 className="text-2xl font-bold mb-4 text-[#0f172a]">{isRtl ? "إدارة وتنظيم المؤتمرات" : "Conference Management"}</h3>
                <p className="text-slate-500 font-medium mb-10 text-sm">{isRtl ? "نظام متكامل لتسجيل الحضور وإدارة الجلسات بكل سهولة واحترافية." : "Integrated system for attendance registration and session management with ease."}</p>
              ...
              <motion.div
                ...
                className="bg-white/70 backdrop-blur-sm animate-mesh rounded-[2.5rem] p-6 md:p-10 border border-slate-200 shadow-md flex flex-col items-start text-start overflow-hidden relative group min-h-[400px]"
              >
                <h3 className="text-2xl font-bold mb-4 text-[#0f172a]">{isRtl ? "استراتيجيات الحجز الذكي" : "Smart Booking Strategies"}</h3>
                <p className="text-slate-500 font-medium mb-10 text-sm">{isRtl ? "حوّل الزوار إلى مشاركين من خلال أنظمة حجز مرنة وسهلة الاستخدام." : "Convert visitors into participants through flexible and easy-to-use booking systems."}</p>
                <div className="mt-auto w-full bg-white rounded-2xl p-6 shadow-sm border border-slate-100 h-40 flex flex-col justify-center items-center">
                  <div className="w-24 h-24">
                    <DotLottieReact src="https://lottie.host/f7c24d79-64e8-4a2c-9098-c9d0f4fe880b/d5sRehuBaY.lottie" loop autoplay className="w-24 h-24" />
                  </div>
              ...
              <motion.div
                ...
                className="bg-white/70 backdrop-blur-sm animate-mesh rounded-[2.5rem] p-6 md:p-10 border border-slate-200 shadow-md flex flex-col items-start text-start overflow-hidden relative group min-h-[400px]"
              >
                <h3 className="text-2xl font-bold mb-4 text-[#0f172a]">{isRtl ? "الاستجابة والخدمة الفورية" : "Immediate Support & Response"}</h3>
                <p className="text-slate-500 font-medium mb-10 text-sm">{isRtl ? "فريق دعم متخصص يعمل على مدار الساعة لضمان تجربة مثالية لضيوفك وحل كافة التحديات فوراً." : "A dedicated support team working around the clock to ensure a perfect guest experience and solve all challenges immediately."}</p>
          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center text-center mb-16">
              ...
              <h2 className={`text-2xl md:text-5xl lg:text-6xl ${isRtl ? 'font-bold' : 'font-extrabold'} tracking-tighter text-[#0f172a] mb-6 leading-[1.4] md:leading-[1.6]`}>
                {isRtl ? "مصمم ليحقق لك " : "Built to Help You "}
                <span className="inline-flex items-center align-middle relative overflow-visible mx-2" style={{ direction: 'ltr' }}>
                  <div className="relative w-16 h-16 md:w-24 md:h-24 -ml-4 -mr-2 flex items-center justify-center shrink-0">
                    <DotLottieReact
                      src="https://lottie.host/6a0f3a81-fdbb-46cf-8d70-88d6b7d3c576/yVrnQkFwxr.lottie"
                      loop
                      autoplay
                      className="relative z-10 w-full h-full"
                    />
                  </div>
                  <span className="bg-gradient-to-r from-brand-purple to-brand-blue bg-clip-text text-transparent font-extrabold relative z-10 px-1" style={{ direction: isRtl ? 'rtl' : 'ltr' }}>
                    {isRtl ? "النجاح" : "Grow"}
                  </span>
                </span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-[1200px] mx-auto">
              ...
              <div className="flex flex-col gap-6">
                ...
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  className="bg-white rounded-[2rem] p-8 border border-slate-200 shadow-md flex flex-col min-h-[450px] md:h-[500px] relative overflow-hidden group"
                >
                  ...
                  <div className="w-full relative flex items-center justify-center flex-1 mb-6">
                    ...
                    <div className="w-20 h-20 z-20 relative">
                      <DotLottieReact src="https://lottie.host/638d4dd8-7e5c-4e60-9313-7ad6928d848f/2jWx4KmHKg.lottie" loop autoplay className="w-20 h-20" />
                    </div>
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: 0.1 }}
                  className="bg-white rounded-[2rem] p-8 border border-slate-200 shadow-md flex flex-col min-h-[350px] md:h-[400px]"
                >
                  <div className="w-full relative flex items-center justify-center flex-1 mb-6">
                    {/* Glow */}
              ...
              <div className="flex flex-col gap-6">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: 0.2 }}
                  className="bg-white rounded-[2rem] p-8 border border-slate-200 shadow-md flex flex-col min-h-[300px] md:h-[350px]"
                >
                ...
                <motion.div
                  ...
                  className="bg-white rounded-[2rem] p-8 border border-slate-200 shadow-md flex flex-col min-h-[450px] md:h-[550px] relative overflow-hidden"
                >
                  <div className="w-full relative flex items-center justify-center flex-1 mb-6">
                    ...
                    <div className="w-24 h-24 z-10 relative">
                      <DotLottieReact src="https://lottie.host/0586338a-c54d-4c8e-b19c-4570477053a0/YvCHf5kV2P.lottie" loop autoplay className="w-24 h-24" />
                    </div>
                    {/* Floating items */}
              ...
              <div className="flex flex-col gap-6">
                ...
                <motion.div
                  ...
                  className="bg-white rounded-[2rem] p-8 border border-slate-200 shadow-md flex flex-col min-h-[400px] md:h-[460px] overflow-hidden"
                >
                ...
                <motion.div
                  ...
                  className="bg-white rounded-[2rem] p-2 pb-8 border border-slate-200 shadow-md flex flex-col min-h-[400px] md:h-[440px]"
                >
                  <div className="w-full h-48 rounded-[1.5rem] animate-mesh mb-8 relative overflow-hidden flex-shrink-0 flex items-center justify-center" style={{ background: 'linear-gradient(-45deg, #a78bfa, #38bdf8, #818cf8, #22d3ee)', backgroundSize: '400% 400%', animation: 'mesh 8s ease infinite' }}>
                    <DotLottieReact src="https://lottie.host/1468e726-1b22-4bfb-836b-f673bc08f51c/xuurHOhPSS.lottie" loop autoplay style={{ width: '100%', height: '100%' }} />
                  </div>
                  <div className="px-6 flex-1 flex flex-col justify-between">
                    ...
                    <Button
                      ...
                      className="mt-8 bg-gradient-to-r from-brand-purple to-brand-blue hover:scale-105 transition-transform text-white rounded-full font-extrabold px-8 h-12 w-fit shadow-[0_10px_30px_-5px_hsl(var(--brand-purple)/0.4)] flex items-center gap-2"
                    >
